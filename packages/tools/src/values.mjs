...
export const DATA_DIR = resolve(HERE, "../../sim-data/data");
export const REPORT_DIR = resolve(HERE, "../reports");
...
export function loadData() {
  const resourcesDoc = JSON.parse(readFileSync(join(DATA_DIR, "resources.json"), "utf8"));
  const recipesDoc = JSON.parse(readFileSync(join(DATA_DIR, "recipes.json"), "utf8"));
  const buildingsDoc = JSON.parse(readFileSync(join(DATA_DIR, "buildings.json"), "utf8"));
