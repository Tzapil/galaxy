...
export type { ResourceAmount, StageOneBatchRecipe, StageOneBuildingDef, StageOneContinuousProcess, StageOneData, StageOnePopulationNeeds, StageOneResource } from "./stage-one/data.js";
