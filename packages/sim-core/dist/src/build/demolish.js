...
export function canDemolishByFlow(data, world, building) {
...
export function demolishBuilding(data, world, building, tick) {
...
export function dailyProductionOnBody(data, world, body) {
...
export function dailyDemandOnBody(data, world, body) {
